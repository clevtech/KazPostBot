...
gmap_client = Client(key='AIzaSyDoeo7qC9CjjFpphoW2bE7JTGoNkrSo_cw')
start = "пр-т. Мангилик Ел. 20, Астана 020000"
end = "пр-т. Мангилик Ел. 20, Астана 020000"
# directions = directions(gmap_client, start, end, mode='walking')[0]
# print(directions.keys())
# print(directions['waypoint_order'])
directions_result = gmap_client.directions(start, end, mode="walking")[0]
directions_legs = directions_result['legs'][0]
steps = directions_legs['steps']
print(polyline.decode(steps[5]['polyline']['points']))